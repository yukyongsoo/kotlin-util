...
class RequestQuery {
    ...
    fun string(name: String, description: String = "", optional: Boolean = false): ParameterDescriptorWithType {
        return param(name, SimpleType.STRING, description, optional)
    }

    fun number(name: String, description: String = "", optional: Boolean = false): ParameterDescriptorWithType {
        return param(name, SimpleType.NUMBER, description, optional)
    }

    fun bool(name: String, description: String = "", optional: Boolean = false): ParameterDescriptorWithType {
